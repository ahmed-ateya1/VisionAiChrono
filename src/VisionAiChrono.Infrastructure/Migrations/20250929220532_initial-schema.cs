        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageLimitInGB = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    UsedStorageInGB = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BasePipelineId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pipelines_Pipelines_BasePipelineId",
                        column: x => x.BasePipelineId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favourites_Pipelines_PipelineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PipelineRuns_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PipelineResults_AiModels_AiModelId",
                        column: x => x.AiModelId,
                        principalTable: "AiModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PipelineResults_PipelineRuns_PipelineRunId",
                        column: x => x.PipelineRunId,
                        principalTable: "PipelineRuns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PipelineResults_Videos_VideoId",
                        column: x => x.VideoId,
                        principalTable: "Videos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourites_PipelineId",
                table: "Favourites",
                column: "PipelineId");

            migrationBuilder.CreateIndex(
                name: "IX_Favourites_UserId_PipelineId",
                table: "Favourites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PipelineModels_PipelineId_StepOrder",
                table: "PipelineModels",
                columns: new[] { "PipelineId", "StepOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PipelineResults_AiModelId",
                table: "PipelineResults",
                column: "AiModelId");

            migrationBuilder.CreateIndex(
                name: "IX_PipelineResults_PipelineRunId",
                table: "PipelineResults",
                column: "PipelineRunId");

            migrationBuilder.CreateIndex(
                name: "IX_PipelineResults_VideoId",
                table: "PipelineResults",
                column: "VideoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pipelines_BasePipelineId",
                table: "Pipelines",
                column: "BasePipelineId");
